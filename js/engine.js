...
const ITEMS = [
  // Type 1
  { id: 1, type: 1, text: "I notice small mistakes in things other people are perfectly happy with." },
  { id: 2, type: 1, text: "When a task is finished, I can already see exactly how it could have been done better." },
  { id: 3, type: 1, text: "I have a clear inner sense of right and wrong, and I trust it." },
  { id: 4, type: 1, text: "I find it hard to relax while something around me is out of order." },
  { id: 5, type: 1, text: "People sometimes call me critical even when I'm only trying to help." },
  // Type 2
  ...
  { id: 10, type: 2, text: "It stings when someone doesn't seem to appreciate what I did for them." },
  // Type 3
  ...
  { id: 20, type: 4, text: "I need quiet time alone to sort out how I feel." },
  // Type 5
  ...
  { id: 30, type: 6, text: "I read between the lines; I notice when people's motives shift." },
  // Type 7
  ...
  { id: 39, type: 8, text: "Showing vulnerability does not come easily to me; I show strength instead." },
  { id: 40, type: 8, text: "I trust my gut and act on it quickly." },
  // Type 9
  ...
  { id: 45, type: 9, text: "People tell me I am easygoing — sometimes a little too easygoing." },
];
